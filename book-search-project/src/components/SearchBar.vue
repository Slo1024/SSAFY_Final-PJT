      ...
      <div>
        <div>
          <button class="select-btn" @click="toggleSelect">
            {{ selectedOption }}
            <img style="width:8px;margin-top: 2px;" src="../assets/img/select-down.svg" alt="" :class="{ rotated: showSelect }">
          </button>
...
.select-wrap{
  ...
  border: 1px solid #bbbbbb;border-radius: 29px;
  height: 40px;
  margin: 0 auto;
  width: fit-content;
}
